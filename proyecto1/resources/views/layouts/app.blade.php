...
<body>
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{ url('/logina/form') }}" class="list-group-item list-group-item-action">Inicio</a>
        <a href="{{ url('/desbastels') }}" class="list-group-item list-group-item-action">Desbaste</a>
        <a href="{{ url('/acabadols') }}" class="list-group-item list-group-item-action">Acabado</a>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-silver shadow-sm">
            <div class="container">
                <div class="logo-container">
                    ...
                    <a class="navbar-brand" href="{{ url('/logina/form') }}">M-RAM CNC</a>
                </div>
